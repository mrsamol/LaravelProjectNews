           ...
           @csrf
            <div class="box-body">
              <div class="row">
                <div class="col-xs-12 col-sm-2 col-md-2">
                  <div class="form-group profile-img" style="width: 150px;height: 150px;background: #eee;position: relative;border-radius: 100%;z-index: 0">
                    <img src="{{asset('/assets/uploads/post/')}}/{{$post->image}}" alt="" style="width: 100%;height: 100%;border-radius: 100%;z-index: -1" id="output-image">
                ...
                <div class="col-xs-12 col-sm-10 col-md-10">
                    ...
                    <div class="form-group">
                      ...
                      <select name="cate_id" required="" class="form-control">
                        ...
                        <option value="{{$cate->id}}" @if($cate->id == $post->cate_id) selected="" @endif>{{$cate->name}}</option>
                        @endforeach
                      </select>
                    </div>
                     <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea name="content" class="form-control" rows="7" placeholder="Content">{{$post->content}}</textarea>
              </div>
