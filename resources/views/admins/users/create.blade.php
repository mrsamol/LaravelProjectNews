           ...
           @csrf
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-2 col-md-2">
                  <div class="form-group profile-img" style="width: 150px;height: 150px;background: #eee;position: relative;border-radius: 100%;z-index: 0">
                    <img src="{{asset('/assets/uploads/profile/default.png')}}" alt="" style="width: 100%;height: 100%;border-radius: 100%;z-index: -1" id="output-image">
            ...
            <div class="row">
              ...
              <div class="form-group">
                ...
                <textarea name="education" class="form-control" rows="7" placeholder="Education"></textarea>
              </div>
